...
class ServiceLocator {
  ...
  void init(){
    ...
    //USECASES
    getIt.registerLazySingleton(() =>GetAllTasksUseCase(taskReposatory: getIt()) );
    getIt.registerLazySingleton(() =>UpdateTaskUseCase(taskReposatory: getIt()) );
    getIt.registerLazySingleton(() =>DeleteTaskUseCase(taskReposatory: getIt()) );
    getIt.registerLazySingleton(() =>AddTaskUseCase(taskReposatory: getIt()) );
    
    //REPOSITORY
    getIt.registerLazySingleton<TaskReposatory>(() => TaskReposatoryImpl( localDataSource: getIt()) );

    //DATA SOURCE
    //WHEN I CALL BASE OR NOT BASE IT WILL USE THE SAME OBJECT
    getIt.registerLazySingleton<LocalDataSource>(() => LocalDataSourceImpl( sqfliteHelper: getIt()) );
