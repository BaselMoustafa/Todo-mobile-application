...
import 'package:todo_application/core/service_locator/service_locator.dart';
...
import 'features/tasks/presentation/controller/edit_cubit/edit_cubit.dart';
import 'features/tasks/presentation/controller/tasks_cubit/tasks_cubit.dart';
import 'features/tasks/presentation/controller/view_cubit/view_cubit.dart';
import 'features/tasks/presentation/resources/routes_manager.dart';

void main() async{
  WidgetsFlutterBinding.ensureInitialized();
  ServiceLocator().init();
  await SqfliteHelperImpl.createDataBase();
 ...
 @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers:[
        BlocProvider(
          create: (context) =>getIt<TasksCubit>()..getTasksFromCubit(),          
        ),
        BlocProvider(
          create: (context) =>getIt<ViewCubit>(),          
        ),
        BlocProvider(
