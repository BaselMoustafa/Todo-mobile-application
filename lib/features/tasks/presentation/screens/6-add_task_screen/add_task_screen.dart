          ...
          child: Column(
            children: [
              defultFormField(
                ...
                labeltext: "Content", 
                prefix:Icon(Icons.title_outlined,color: ColorManager.primary,),
                ),
              SizedBox(height: 20,),
                ...
                builder: (context,state){
                  return defultFormField(
                    ontap: ()async{
                      ...
                      if(date !=null)
                      {
                        ViewCubit.get(context).dateController.text= DateFormat.yMMMd().format(date);
                    ...
                    labeltext: "date", 
                    prefix:Icon(Icons.date_range,color: ColorManager.primary,),
                    );
                },
              ),
              SizedBox(height: 20,),
                ...
                builder: (context,state){
                  ...
                  return defultFormField(
                    ...
                    ontap: ()async{
                      ...
                      if(time !=null){
                        ViewCubit.get(context).timeController.text=time.format(context);
                        ViewCubit.get(context).refreshWidgets();
                      }
                    },
                    validate:((value) {
