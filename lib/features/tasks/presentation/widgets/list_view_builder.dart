...
ListView buildListView(List<MyTask> tasksToBeBuild ,context) => ListView.separated(
    itemBuilder: ((context, index) => _buildItem( tasksToBeBuild,tasksToBeBuild[index] , context)), 
